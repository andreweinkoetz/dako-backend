...
public class SharedClientStatistics {
	 ...
	 * <p/>
	 * 25 Anzahl aller Wiederholungen von Events (fuer unzuverlaessige Verbindungen
	 * wie UDP)
	 * <p/>
	...
	public synchronized void writeStatisticSet(String fileName, String implType, String measureType, String startTime,
		...
		try {
			...
			sb.append(formatter.format("%s | %s | %d | %d | "
					+ "%05.2f | %05.2f | %05.2f | %05.2f | %05.2f | %05.2f | %05.2f | %05.2f | %05.2f | %05.2f |  %05.2f |  %05.2f | "
					+ "%d | %d | %d | %d | %d | %d | %d | %d | %d | %d | %02.2f | %s | %s%n", measureType, implType,
					numberOfClients, numberOfMessages, distr.getPercentile10(), distr.getPercentile25(),
					distr.getPercentile50(), distr.getPercentile75(), distr.getPercentile90(), distr.getRange(),
					distr.getInterquartilRange(), distr.getMinimum(), distr.getMaximum(), distr.getMean(),
					distr.getStandardDeviation(), this.getAverageServerTime() / 1000000.0, this.numberOfAllMessages,
